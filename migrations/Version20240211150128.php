 ...
 */
final class Version20240211150128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ouverture (id INT AUTO_INCREMENT NOT NULL, jour VARCHAR(255) NOT NULL, hdmatin TIME DEFAULT NULL, hfmatin TIME DEFAULT NULL, hdapresmidi TIME DEFAULT NULL, hfapresmidi TIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
